    ...
    <main ref={rootRef} className="legal-page">
      ...
      <section className="legal-hero route-motion-section route-hero" aria-labelledby="legal-heading">
        <div>
          ...
          <p className="route-motion-item">Privacy, cookies and website terms for visitors, requesters and prospective Klimori customers in the USA and globally.</p>
        </div>
        <dl className="route-motion-item"><div><dt>Last updated</dt><dd>16 July 2026</dd></div><div><dt>Region</dt><dd>USA / Global</dd></div><div><dt>Contact</dt><dd><a href="mailto:privacy@klimori.com">privacy@klimori.com</a></dd></div></dl>
      </section>
      ...
      <section className="legal-section route-motion-section" id="privacy" aria-labelledby="privacy-heading">
        ...
        <div className="legal-content">
          <LegalBlock number="01" title="Controller and contact"><p>Klimori, 18206 Spink Ln, Frankfort, SD 57440, USA, is responsible for personal data processed through this website. Privacy questions and rights requests can be sent to <a href="mailto:privacy@klimori.com">privacy@klimori.com</a> or by phone at <a href="tel:+16054721255">+1 605-472-1255</a>.</p></LegalBlock>
      ...
      <section className="legal-section route-motion-section" id="terms" aria-labelledby="terms-heading">
        <div className="legal-section__intro route-motion-heading"><RouteLabel>Website terms</RouteLabel><h2 id="terms-heading">Using the Klimori website.</h2><p>These terms cover the public website and request enquiry experience. Product subscriptions will require a separate signed commercial agreement.</p></div>
        <div className="legal-content">
          <LegalBlock number="01" title="Website purpose"><p>The website provides general information about Klimori's building energy intelligence products. Operating examples are not guarantees of savings, performance or outcomes for a specific building.</p></LegalBlock>
      ...
      <section className="legal-resources route-motion-section" aria-labelledby="legal-resources-heading">
        <div className="route-motion-heading"><RouteLabel>Official guidance</RouteLabel><h2 id="legal-resources-heading">Global privacy resources.</h2></div>
        <div>
          <a className="route-motion-item" href="https://europa.eu/youreurope/business/dealing-with-customers/data-protection/data-protection-gdpr/index_en.htm" target="_blank" rel="noreferrer"><span>Privacy guidance for businesses</span><ExternalLink size={16} /></a>
          <a className="route-motion-item" href="https://www.edpb.europa.eu/topics/key-gdpr-concepts/data-subject-rights_en" target="_blank" rel="noreferrer"><span>Data rights guidance</span><ExternalLink size={16} /></a>
        </div>
        <p className="route-motion-item"><Check size={16} /> Final legal text should be reviewed by qualified US counsel before publication.</p>
      </section>
      <SiteFooter />
    </main>
  );
