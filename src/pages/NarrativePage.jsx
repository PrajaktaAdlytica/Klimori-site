...
const pages = {
  ...
  company: {
    ...
    lede: "Klimori is a Poland and EU-based product company creating a clearer operating layer for commercial buildings and the teams responsible for them.",
    ...
    imageLabel: "Poland / European Union",
    metrics: [["PL / EU", "product base"], ["B2B", "commercial building focus"], ["1", "operator-led mission"]],
